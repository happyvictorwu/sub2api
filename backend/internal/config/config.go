...
func configureConfigSource(setConfigFile, addConfigPath func(string)) {
	...
	addConfigPath("/etc/slothwatching")
}
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "slothwatching")
	...
	viper.SetDefault("webauthn.rp_display_name", "Slothwatching")
	...
	viper.SetDefault("database.dbname", "slothwatching")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "slothwatching:")
