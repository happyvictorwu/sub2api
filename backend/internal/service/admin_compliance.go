...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/happyvictorwu/sub2api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/happyvictorwu/sub2api/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Slothwatching 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Slothwatching Deployment and Operation Compliance Commitment"
