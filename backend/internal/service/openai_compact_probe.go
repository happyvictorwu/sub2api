...
func compactProbeSessionID(accountID int64) string {
	if accountID <= 0 {
		return deriveStableUUIDv4("slothwatching:codex-compact-probe:v1:anonymous")
	}
	return deriveStableUUIDv4("slothwatching:codex-compact-probe:v1:" + strconv.FormatInt(accountID, 10))
}
