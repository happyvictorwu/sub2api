#!/bin/bash
# =============================================================================
# Slothwatching Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for Slothwatching:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/happyvictorwu/sub2api/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  Slothwatching Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose logs -f slothwatching"
    echo ""
