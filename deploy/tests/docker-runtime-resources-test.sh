...
assert_line Dockerfile.goreleaser 'COPY --chown=slothwatching:slothwatching backend/resources /app/resources'
assert_line deploy/Dockerfile 'COPY --from=backend-builder --chown=slothwatching:slothwatching /app/backend/resources /app/resources'
