...
const GITHUB_REPO = 'happyvictorwu/sub2api'
// Docker Hub image published by CI (tags carry no "v" prefix, e.g. slothwatching:0.1.146)
const DOCKER_IMAGE = 'slothwatching'
