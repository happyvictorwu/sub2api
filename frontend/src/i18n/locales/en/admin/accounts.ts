export default {
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by slothwatching, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within slothwatching.',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. Slothwatching cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from Slothwatching connectivity test.',
        ttsTextDefault: 'Hello from Slothwatching account connectivity test.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another slothwatching instance.',
