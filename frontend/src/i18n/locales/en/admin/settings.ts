export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Slothwatching end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Slothwatching end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, Slothwatching temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream Slothwatching sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Slothwatching',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Slothwatching orders; the upstream type is sent as EasyPay type.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Slothwatching',
        useTls: 'Use TLS',
