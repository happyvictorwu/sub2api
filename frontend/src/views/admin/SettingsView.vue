              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "Slothwatching") +
                        " 100 " +
                ...
                <!-- Row 4: Enabled payment types (provider badges like slothwatchingpay) -->
                <div>
                  <label class="input-label">{{
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/happyvictorwu/sub2api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/happyvictorwu/sub2api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/happyvictorwu/sub2api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/happyvictorwu/sub2api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
