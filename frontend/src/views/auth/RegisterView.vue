...
const LOGIN_AGREEMENT_STORAGE_KEY = 'slothwatching_login_agreement_consent'
...
const siteName = ref<string>('Slothwatching')
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'Slothwatching'
