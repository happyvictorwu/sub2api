...
This document provides practical examples of how to use the authentication views in the Slothwatching frontend.
...
//   - Token stored in localStorage
//   - User data stored in state
//   - Success toast: "Account created successfully! Welcome to Slothwatching."
